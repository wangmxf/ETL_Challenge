...
for x in range(0, len(personal_investors)):
	...
	p_response = json.load(urlopen('http://api.crunchbase.com/v/1/person/' + personal_investors[x] + '.js?api_key=b6erucspnpp9pghb2xxtthn4'))
...
for y in range(0, len(company_investors)):
	...
	c_response = json.load(urlopen('http://api.crunchbase.com/v/1/company/' + company_investors[y] + '.js?api_key=b6erucspnpp9pghb2xxtthn4'))
...
for z in range(0, len(fin_investors)):
	...
	f_response = json.load(urlopen('http://api.crunchbase.com/v/1/financial-organization/' + fin_investors[z] + '.js?api_key=b6erucspnpp9pghb2xxtthn4'))
